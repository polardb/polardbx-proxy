...
/**
 * @author lingce.ldm 2017-09-12 10:53
 */
public class DALAnalyzeTableStatement implements SQLStatement {

    private List<Identifier> tableNames;

    public DALAnalyzeTableStatement(List<Identifier> tableNames) {
    ...
    public void setTableNames(List<Identifier> tableNames) {
        this.tableNames = tableNames;
    }
}
