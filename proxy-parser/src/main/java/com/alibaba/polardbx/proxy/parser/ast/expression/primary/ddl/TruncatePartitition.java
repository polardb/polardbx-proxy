 ...
 */
public class TruncatePartitition implements AlterSpecification {

    public TruncatePartitionType getTruncatePartitionType() {
        return truncatePartitionType;
    }
    ...
    public void setTruncatePartitionType(TruncatePartitionType truncatePartitionType) {
        this.truncatePartitionType = truncatePartitionType;
    }

    public static enum TruncatePartitionType {
        PARTITION_NAMES, ALL
    }

    private TruncatePartitionType truncatePartitionType;
