 ...
 */
package com.alibaba.polardbx.proxy.parser.ast.fragment.ddl.datatype;
...
public class DataType implements ASTNode {
    ...
    public static enum DataTypeName {
        ...
        LONGTEXT, ENUM, SET, GEOMETRY, POINT, LINESTRING, POLYGON, MULTIPOINT, MULTILINESTRING, MULTIPOLYGON,
        GEOMETRYCOLLECTION, NVARCHAR, NCHAR, JSON
    }
