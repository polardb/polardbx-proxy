...
/**
 * Created by guoguan on 15-11-6.
 */
public class LineStringFromText extends FunctionExpression {

    public LineStringFromText(List<Expression> arguments) {
        super("LINESTRINGFROMTEXT", arguments);
    }

    @Override
    public FunctionExpression constructFunction(List<Expression> arguments) {
        return new LineStringFromText(arguments);
    }
}
