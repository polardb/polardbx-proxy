 ...
 */
public class GeometryFromWKB extends FunctionExpression {

    public GeometryFromWKB(List<Expression> arguments) {
        super("GEOMETRYFROMWKB", arguments);
    }

    @Override
    public FunctionExpression constructFunction(List<Expression> arguments) {
        return new GeometryFromWKB(arguments);
    }
}
