 ...
 */
public class LiteralDateString extends LiteralString {
    /**
     * @param string content of string, excluded of head and tail "'". e.g. for
     */
    public LiteralDateString(String introducer, String string, boolean nchars) {
        super(introducer, string, nchars);
    }

    @Override
    public LiteralStringType getType() {
        return LiteralStringType.DATE;
    }
}
