 ...
 */
public class ReorganizePartition implements AlterSpecification {

    private final List<Identifier>          partition_names;
    private final List<PartitionDefinition> partitionDefinitionList;

    public ReorganizePartition(List<Identifier> partition_names, List<PartitionDefinition> partitionDefinitionList){
