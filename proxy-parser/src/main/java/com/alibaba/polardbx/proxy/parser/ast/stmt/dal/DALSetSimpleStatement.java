 ...
 */
public class DALSetSimpleStatement implements SQLStatement {

    List<Pair<String, String>> setVals;

    public DALSetSimpleStatement(List<Pair<String, String>> setVals) {
    ...
    public List<Pair<String, String>> getVals() {
        return setVals;
    }
}
