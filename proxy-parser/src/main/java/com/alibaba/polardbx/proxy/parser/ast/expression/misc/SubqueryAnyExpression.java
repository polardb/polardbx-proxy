 ...
 * @author QIU Shuo
 */
public class SubqueryAnyExpression extends BinaryOperatorExpression {

    private MySQLToken op;

    public SubqueryAnyExpression(Expression fst, QueryExpression subquery, MySQLToken op) {
    ...
    public String getOperator() {
        return getNameFromOperator(op) + " ANY";
    }
