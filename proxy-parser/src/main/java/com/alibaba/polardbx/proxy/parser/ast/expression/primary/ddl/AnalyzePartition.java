 ...
 */
public class AnalyzePartition implements AlterSpecification {

    public AnalyzePartitionType getAnalyzePartitionType() {
        return analyzePartitionType;
    }

    public void setAnalyzePartitionType(AnalyzePartitionType analyzePartitionType) {
        this.analyzePartitionType = analyzePartitionType;
    }
    ...
    public static enum AnalyzePartitionType {
        PARTITION_NAMES, ALL
    }

    private AnalyzePartitionType analyzePartitionType;
