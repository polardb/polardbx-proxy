...
/**
 * ADD PARTITION (partition_definition) Created by simiao on 15-5-14.
 */
public class AddPartitition implements AlterSpecification {

    private final PartitionDefinition partitionDefinition;

    public AddPartitition(PartitionDefinition partitionDefinition){
