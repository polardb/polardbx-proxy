 ...
 */
public class RebuildPartition implements AlterSpecification {
    ...
    public RebuildPartitionType getRebuildPartitionType() {
        return rebuildPartitionType;
    }

    public void setRebuildPartitionType(RebuildPartitionType rebuildPartitionType) {
        this.rebuildPartitionType = rebuildPartitionType;
    }
    ...
    public static enum RebuildPartitionType {
        PARTITION_NAMES, ALL
    }

    private RebuildPartitionType rebuildPartitionType;
