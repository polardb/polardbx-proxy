 ...
 */
public class CheckPartition implements AlterSpecification {

    public CheckPartitionType getCheckPartitionType() {
        return checkPartitionType;
    }

    public void setCheckPartitionType(CheckPartitionType checkPartitionType) {
        this.checkPartitionType = checkPartitionType;
    }
    ...
    public static enum CheckPartitionType {
        PARTITION_NAMES, ALL
    }

    private CheckPartitionType checkPartitionType;
