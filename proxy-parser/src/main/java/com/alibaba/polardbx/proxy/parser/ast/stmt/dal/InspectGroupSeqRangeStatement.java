 ...
 */
public class InspectGroupSeqRangeStatement implements SQLStatement {

    private Identifier name;

    public InspectGroupSeqRangeStatement() {

    }

    public InspectGroupSeqRangeStatement(Identifier name) {
        this.name = name;
    }
