...
public class DDLCreateIndexStatement implements DDLStatement {
    ...
    public static enum IndexConstraintType {
        UNIQUE, FULLTEXT, SPATIAL;
    }

    public DDLCreateIndexStatement(Identifier indexName, Identifier table, IndexConstraintType constraintType,
                                   List<IndexColumnName> columns, IndexDefinition.IndexType indexType,
                                   List<IndexOption> options, AlgorithmType algorithmType, LockType lockType) {
