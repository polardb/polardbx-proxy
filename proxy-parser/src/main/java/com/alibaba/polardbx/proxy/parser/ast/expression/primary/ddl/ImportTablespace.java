...
public class ImportTablespace implements AlterSpecification {
    ...
    public ImportTSType getImportTSType() {
        return importTSType;
    }

    public static enum ImportTSType {
        DISCARD, IMPORT
    }

    private final ImportTSType importTSType;

    public ImportTablespace(ImportTSType importTSType){
        this.importTSType = importTSType;
    }
