...
import com.alibaba.polardbx.proxy.parser.ast.expression.arithmeic.ArithmeticAddExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.arithmeic.ArithmeticDivideExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.arithmeic.ArithmeticIntegerDivideExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.arithmeic.ArithmeticModExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.arithmeic.ArithmeticMultiplyExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.arithmeic.ArithmeticSubtractExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.arithmeic.MinusExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.bit.BitAndExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.bit.BitInvertExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.bit.BitOrExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.bit.BitShiftExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.bit.BitXORExpression;
...
import com.alibaba.polardbx.proxy.parser.ast.expression.comparison.ComparisionGreaterThanExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.comparison.ComparisionGreaterThanOrEqualsExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.comparison.ComparisionIsExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.comparison.ComparisionLessOrGreaterThanExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.comparison.ComparisionLessThanExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.comparison.ComparisionLessThanOrEqualsExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.comparison.ComparisionNotEqualsExpression;
...
import com.alibaba.polardbx.proxy.parser.ast.expression.logical.LogicalNotExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.logical.LogicalOrExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.logical.LogicalXORExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.logical.NegativeValueExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.misc.AssignmentExpression;
...
import com.alibaba.polardbx.proxy.parser.ast.expression.misc.SubqueryAllExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.misc.SubqueryAnyExpression;
...
import com.alibaba.polardbx.proxy.parser.ast.expression.primary.MatchExpression.Modifier;
...
import com.alibaba.polardbx.proxy.parser.ast.expression.primary.Wildcard;
...
import com.alibaba.polardbx.proxy.parser.ast.expression.primary.function.string.Trim.Direction;
...
import com.alibaba.polardbx.proxy.parser.ast.expression.primary.literal.LiteralDateString;
...
import com.alibaba.polardbx.proxy.parser.ast.expression.primary.literal.LiteralTimeString;
import com.alibaba.polardbx.proxy.parser.ast.expression.primary.literal.LiteralTimestampString;
import com.alibaba.polardbx.proxy.parser.ast.expression.string.LikeExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.string.RegexpExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.string.SoundsLikeExpression;
import com.alibaba.polardbx.proxy.parser.ast.expression.type.CastBinaryExpression;
...
import com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLFunctionManager;
...
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.EOF;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.IDENTIFIER;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_AND;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_AS;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_ASC;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_BY;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_COLLATE;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_DATE;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_DESC;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_DISTINCT;
...
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_INT;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_INTEGER;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_LIKE;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_NOT;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_SELECT;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_SEPARATOR;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_THEN;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_TIME;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_TIMESTAMP;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_WHEN;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.KW_WITH;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.LITERAL_CHARS;
...
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.OP_GREATER_OR_EQUALS;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.OP_GREATER_THAN;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.OP_LESS_OR_EQUALS;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.OP_LESS_OR_GREATER;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.OP_LESS_THAN;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.OP_NOT_EQUALS;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.PUNC_COMMA;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.PUNC_DOT;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.PUNC_LEFT_PAREN;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.PUNC_RIGHT_PAREN;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.QUESTION_MARK;
import static com.alibaba.polardbx.proxy.parser.recognizer.mysql.MySQLToken.USR_VAR;
...
public class MySQLExprParser extends MySQLParser {
    ...
    public MySQLExprParser(MySQLLexer lexer, MySQLFunctionManager functionManager, boolean cacheEvalRst) {
        ...
        for (Expression fst = bitOrExpression(null, null); ; ) {
            ...
            case KW_NOT:
                ...
                case KW_LIKE:
                    ...
                    continue;
                case KW_IN:
                    if (lexer.nextToken() == QUESTION_MARK) {
                        int index = lexer.paramIndex();
                        lexer.nextToken();
                        fst = createParam(index);
                        continue;
                    }
            ...
            case KW_IS:
                ...
                case KW_NOT:
                    ...
                    case LITERAL_NULL:
                        lexer.nextToken();
                        fst = new ComparisionIsExpression(fst, ComparisionIsExpression.IS_NOT_NULL)
                            .setCacheEvalRst(cacheEvalRst);
                        continue;
                    case LITERAL_BOOL_FALSE:
                        lexer.nextToken();
                        fst = new ComparisionIsExpression(fst, ComparisionIsExpression.IS_NOT_FALSE)
                            .setCacheEvalRst(cacheEvalRst);
                        continue;
                    case LITERAL_BOOL_TRUE:
                        lexer.nextToken();
                        fst = new ComparisionIsExpression(fst, ComparisionIsExpression.IS_NOT_TRUE)
                            .setCacheEvalRst(cacheEvalRst);
                        continue;
                    default:
                        matchIdentifier("UNKNOWN");
                        fst = new ComparisionIsExpression(fst, ComparisionIsExpression.IS_NOT_UNKNOWN)
                            .setCacheEvalRst(cacheEvalRst);
                        continue;
                    }
                case LITERAL_NULL:
                ...
                default:
                    matchIdentifier("UNKNOWN");
                    fst = new ComparisionIsExpression(fst, ComparisionIsExpression.IS_UNKNOWN)
                        .setCacheEvalRst(cacheEvalRst);
                    continue;
                }
            case OP_EQUALS:
                lexer.nextToken();
                temp = anyAllExpression(fst, OP_EQUALS);
                if (temp instanceof SubqueryAllExpression || temp instanceof SubqueryAnyExpression) {
                    fst = temp.setCacheEvalRst(cacheEvalRst);
                } else {
            ...
            case OP_GREATER_OR_EQUALS:
                lexer.nextToken();
                temp = anyAllExpression(fst, OP_GREATER_OR_EQUALS);
                if (temp instanceof SubqueryAllExpression || temp instanceof SubqueryAnyExpression) {
                    fst = temp.setCacheEvalRst(cacheEvalRst);
                } else {
            ...
            case OP_GREATER_THAN:
                lexer.nextToken();
                temp = anyAllExpression(fst, OP_GREATER_THAN);
                if (temp instanceof SubqueryAllExpression || temp instanceof SubqueryAnyExpression) {
                    fst = temp.setCacheEvalRst(cacheEvalRst);
                } else {
            ...
            case OP_LESS_OR_EQUALS:
                lexer.nextToken();
                temp = anyAllExpression(fst, OP_LESS_OR_EQUALS);
                if (temp instanceof SubqueryAllExpression || temp instanceof SubqueryAnyExpression) {
                    fst = temp.setCacheEvalRst(cacheEvalRst);
                } else {
            ...
            case OP_LESS_THAN:
                lexer.nextToken();
                temp = anyAllExpression(fst, OP_LESS_THAN);
                if (temp instanceof SubqueryAllExpression || temp instanceof SubqueryAnyExpression) {
                    fst = temp.setCacheEvalRst(cacheEvalRst);
                } else {
            ...
            case OP_LESS_OR_GREATER:
                lexer.nextToken();
                temp = anyAllExpression(fst, OP_LESS_OR_GREATER);
                if (temp instanceof SubqueryAllExpression || temp instanceof SubqueryAnyExpression) {
                    fst = temp.setCacheEvalRst(cacheEvalRst);
                } else {
            ...
            case OP_NOT_EQUALS:
                lexer.nextToken();
                temp = anyAllExpression(fst, OP_NOT_EQUALS);
                if (temp instanceof SubqueryAllExpression || temp instanceof SubqueryAnyExpression) {
                    fst = temp.setCacheEvalRst(cacheEvalRst);
                } else {
    ...
    private Expression anyAllExpression(Expression fst, MySQLToken op) throws SQLSyntaxErrorException {
        ...
        case KW_ALL:
            ...
            return new SubqueryAllExpression(fst, subquery, op).setCacheEvalRst(cacheEvalRst);
        default:
            ...
            if (lexer.nextToken() == PUNC_LEFT_PAREN) {
                ...
                subquery = subQuery();
                match(PUNC_RIGHT_PAREN);
                return new SubqueryAnyExpression(fst, subquery, op).setCacheEvalRst(cacheEvalRst);
            }
    ...
    private Expression primaryExpression(final String consumed, String consumedUp) throws SQLSyntaxErrorException {
        if (consumed != null) {
            return startedFromIdentifier(consumed, consumedUp, lexer.getLastTokenIndex());
        }
        String tempStr;
        String tempStrUp;
        ...
        case KW_EXISTS:
            ...
            return new Exists(exprList).setCacheEvalRst(cacheEvalRst);
        // return new ExistsPrimary((QueryExpression)
        // tempExpr).setCacheEvalRst(cacheEvalRst);
        case USR_VAR:
            tempStr = lexer.stringValue();
        ...
        case KW_TIMESTAMP:
        case KW_TIME:
            MySQLToken nextToken = lexer.nextToken();
            if (nextToken == PUNC_LEFT_PAREN) {
                int functionNameIndexToken = lexer.getLastTokenIndex();
                return ordinaryFunction(lexer.stringValue(), lexer.stringValueUppercase(), functionNameIndexToken);
            } else if (nextToken == LITERAL_CHARS) {
                tempSb = new StringBuilder();
                lexer.appendStringContent(tempSb);
                if (lexer.getLastToken() == KW_DATE) {
                    return new LiteralDateString(null, tempSb.toString(), false).setCacheEvalRst(cacheEvalRst);
                } else if (lexer.getLastToken() == KW_TIMESTAMP) {
                    return new LiteralTimestampString(null, tempSb.toString(), false).setCacheEvalRst(cacheEvalRst);
                } else if (lexer.getLastToken() == KW_TIME) {
                    return new LiteralTimeString(null, tempSb.toString(), false).setCacheEvalRst(cacheEvalRst);
                }
                lexer.nextToken();
            }
            throw err(
                "Key word 'DATE/TIME/TIMESTAMP' should either be followed by a parenthesis or a string of date/time");
        case KW_CURRENT_TIMESTAMP:
        case KW_LOCALTIME:
        case KW_LOCALTIMESTAMP:
            lexer.nextToken();

            List<Expression> argsOfNow = null;
            if (lexer.token() == PUNC_LEFT_PAREN) {
                lexer.nextToken();

                /**
                 * CURRENT_TIMESTAMP([fsp])/KW_LOCALTIME([fsp])/
                 * KW_LOCALTIMESTAMP([fsp])
                 */
                if (lexer.token() != PUNC_RIGHT_PAREN) {
                    fspExpr = valueExpression();
                    argsOfNow = new ArrayList<Expression>();
                    argsOfNow.add(fspExpr);
                }

                match(PUNC_RIGHT_PAREN);
            }
            return new Now(argsOfNow).setCacheEvalRst(cacheEvalRst);
        ...
        case KW_VALUES:
            tempStr = lexer.stringValue();
            tempStrUp = lexer.stringValueUppercase();
            String tempStrUp2 = lexer.token().getStr();
            if (!tempStrUp2.equals(tempStrUp)) {
                tempStrUp = tempStr = tempStrUp2;
            }
            int begin = lexer.getLastTokenIndex();
            if (lexer.nextToken() == PUNC_LEFT_PAREN) {
                return ordinaryFunction(tempStr, tempStrUp, begin);
            }
        ...
        case IDENTIFIER:
            tempStr = lexer.stringValue();
            tempStrUp = lexer.stringValueUppercase();
            begin = lexer.getLastTokenIndex();
            lexer.nextToken();
            Expression left = startedFromIdentifier(tempStr, tempStrUp, begin);
            if (lexer.token() == MySQLToken.OP_JSON_EXTRACT
                || lexer.token() == MySQLToken.OP_JSON_UNQUOTE_EXTRACT) {
                boolean unquote = false;
                if (lexer.token() == MySQLToken.OP_JSON_UNQUOTE_EXTRACT) {
                    unquote = true;

                }
                lexer.nextToken();
                if (lexer.token() != LITERAL_CHARS) {
                    throw err("expect " + LITERAL_CHARS);
                }
                tempSb = new StringBuilder();
                lexer.appendStringContent(tempSb);
                LiteralString right = new LiteralString(null, tempSb.toString(), false);
                lexer.stringValue();
                lexer.nextToken();
                return new JsonExtractExpression(left, right, unquote);
            }
    ...
    private Convert functionConvert() throws SQLSyntaxErrorException {
        ...
        case PUNC_COMMA:
            ...
            if (info != null) {
                cvt = new Convert(expr, null, type.getKey(), info.getKey(), info.getValue());
            } else {
                cvt = new Convert(expr, null, type.getKey(), null, null);
            }
        ...
        case KW_USING:
            ...
            // match(IDENTIFIER);
            String tempStr = getStringValue();
            match(PUNC_RIGHT_PAREN);
            cvt = new Convert(expr, tempStr, null, null, null);
            cvt.setCacheEvalRst(cacheEvalRst);
            return cvt;
        default:
            throw err("expect ',' or 'USING' but is " + lexer.token());
    ...
    private Expression startedFromIdentifier(final String consumed, String consumedUp,
                                             int begin) throws SQLSyntaxErrorException {
        Expression tempExpr;
        Expression tempExpr2;
        List<Expression> tempExprList;
        String tempStr;
        ...
        switch (lexer.token()) {
        case PUNC_DOT:
            for (tempExpr = new Identifier(null, consumed, consumedUp).setCacheEvalRst(cacheEvalRst); lexer
                .token() == PUNC_DOT; ) {
                switch (lexer.nextToken()) {
                case IDENTIFIER:
                ...
                default:
                    ...
                    break;
                // throw
                // err("expect IDENTIFIER or '*' after '.', but is "
                // + lexer.token());
                }
            }
            return tempExpr;
        ...
        case PUNC_LEFT_PAREN:
            ...
            case AVG:
                ...
                end = lexer.getLastTokenIndex();

                originStr = lexer.subSql(begin, end - begin).trim();
                return new Avg(tempExpr, tempGroupDistinct).setCacheEvalRst(cacheEvalRst)
                    .setOriginStr(originStr);
            case MAX:
                if (lexer.nextToken() == KW_DISTINCT) {
                    tempGroupDistinct = true;
                    lexer.nextToken();
            ...
            case COUNT:
                ...
                if (lexer.nextToken() == KW_DISTINCT) {
                    ...
                    originStr = lexer.subSql(begin, end - begin).trim();
                    return new Count(tempExprList).setCacheEvalRst(cacheEvalRst).setOriginStr(originStr);
                }
                tempExpr = expression();
                match(PUNC_RIGHT_PAREN);
                ...
                c.setCacheEvalRst(cacheEvalRst);
            ...
            case GROUP_CONCAT:
                ...
                List<Pair<Expression, SortOrder>> orderBys = null;
                ...
                case KW_ORDER:
                    ...
                    do {
                        ...
                        orderBys.add(new Pair<>(tempExpr,
                            tempIsDesc ? SortOrder.DESC : SortOrder.ASC));
                    } while (lexer.token() == PUNC_COMMA && lexer.nextToken() != EOF);
                ...
                return new GroupConcat(tempGroupDistinct,
                    tempExprList,
                    orderBys,
                    tempStr == null ? null : new LiteralString(null, tempStr, false))
                    .setCacheEvalRst(cacheEvalRst);
            case CHAR:
                lexer.nextToken();
                return functionChar();
            ...
            case TIMESTAMPADD:
                ...
                return timestampadd();
            case _ORDINARY:
                return ordinaryFunction(consumed, consumedUp, begin);
            case _USER_DEF:
                return ordinaryFunction(consumed, consumedUp, begin);
            default:
    ...
    private Pair<String, Pair<Expression, Expression>> type4specialFunc() throws SQLSyntaxErrorException {
        ...
        case IDENTIFIER:
            ...
            } else if (!"JSON".equals(typeName) && !"DATE".equals(typeName) && !"DATETIME".equals(typeName)
    ...
    private FunctionExpression ordinaryFunction(String id, String idUpper, int begin) throws SQLSyntaxErrorException {
        ...
        int end = lexer.getLastTokenIndex();

        if (funcExpr == null) {
            throw new SQLSyntaxErrorException(id + "() is not a function");
        }

        String originSql = lexer.subSql(begin, end - begin).trim();
    ...
    private QueryExpression subQuery() throws SQLSyntaxErrorException {
        ...
        return selectParser.selectUnion();
    }

    /**
     * can handle (Math(aaa)) --> Math(aaa) ("#key,1,2#.intValue() % 2") -->
     * '#key,1,2#.intValue() % 2' aaa --> aaa "abc()_{0000}" --> 'abc()_{0000}'
     * can't process aaa(abc) since it's conflict with "partition aaa
     * (subpartition bbb)"
     */
    public Expression freeText() throws SQLSyntaxErrorException {
        ...
        if (!inbracket) {
            freeText.append(lexer.stringValue());
        }
        ...
        while (!loopend) {
            ...
            case PUNC_LEFT_PAREN:
                if (inbracket == false) {
                    loopend = true; // handle abc (subpartition bbb)
                } else {
                    nestylevel++;
                    freeText.append("(");
                }
            ...
            case PUNC_RIGHT_BRACE:
                ...
                break;
            case LITERAL_NUM_PURE_DIGIT:
                freeText.append(lexer.integerValue());
                break;
            case PUNC_COMMA:
                freeText.append(',');
                break;
