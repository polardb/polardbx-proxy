 ...
 */
package com.alibaba.polardbx.proxy.parser.ast.expression.primary.function.groupby;
...
public class GroupConcat extends FunctionExpression {
    ...
    public GroupConcat(boolean distinct, List<Expression> exprList, List<Pair<Expression, SortOrder>> orderBys,
                       LiteralString separator) {
