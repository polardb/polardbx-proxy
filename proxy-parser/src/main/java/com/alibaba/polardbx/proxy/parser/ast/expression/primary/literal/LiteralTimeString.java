 ...
 */
public class LiteralTimeString extends LiteralString {
    /**
     * @param string content of string, excluded of head and tail "'". e.g. for
     */
    public LiteralTimeString(String introducer, String string, boolean nchars) {
        super(introducer, string, nchars);
    }

    @Override
    public LiteralStringType getType() {
        return LiteralStringType.TIME;
    }
}
