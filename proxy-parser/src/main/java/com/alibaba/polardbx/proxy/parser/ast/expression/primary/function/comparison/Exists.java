 ...
 */
package com.alibaba.polardbx.proxy.parser.ast.expression.primary.function.comparison;
 ...
 *
 * @author chenghui.lch 2016年7月17日 下午7:26:51
 * @since 5.0.0
 */
public class Exists extends FunctionExpression {

    public Exists(List<Expression> arguments) {
        super("EXISTS", arguments);
    }
