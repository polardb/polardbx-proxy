...
public class ShowTriggers extends DALShowStatement {
    ...
    public ShowTriggers(boolean full, Identifier schema, String pattern) {
        this.full = full;
        this.schema = schema;
    ...
    public ShowTriggers(boolean full, Identifier schema, Expression where) {
        this.full = full;
        this.schema = schema;
        this.pattern = null;
        this.where = where;
    ...
    public ShowTriggers(boolean full, Identifier schema) {
        this.full = full;
        this.schema = schema;
        this.pattern = null;
        this.where = null;
    ...
    public void setSchema(boolean full, Identifier schema) {
        this.schema = schema;
    }
