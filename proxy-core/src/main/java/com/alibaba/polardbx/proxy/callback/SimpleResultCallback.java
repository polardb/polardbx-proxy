...
public class SimpleResultCallback extends ResultCallbackBase {
    public SimpleResultCallback(@NotNull FrontendConnection frontend, @NotNull FrontendContext context,
    ...
    public void onDone(ResultHandler handler, ResultState lastValidState, ResultState state) {
        ...
        // dealing retransmit or abort(retry by default or you can ignore init retransmit task)
