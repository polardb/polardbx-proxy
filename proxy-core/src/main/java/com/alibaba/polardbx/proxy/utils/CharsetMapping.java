...
public class CharsetMapping {
    ...
    static {
        ...
        MysqlCharset[] charset = new MysqlCharset[] {
            ...
            // Kamenicky encoding usually known as Cp895 but there is no official cp895 specification; close to Cp852, see http://ftp.muni.cz/pub/localization/charsets/cs-encodings-faq
            ...
            new MysqlCharset(MYSQL_CHARSET_NAME_utf8mb3, 3, 0, new String[] {"UTF-8"},
        ...
        collation[33] =
            new Collation(33, new String[] {"utf8mb3_general_ci", "utf8_general_ci"}, 1, MYSQL_CHARSET_NAME_utf8mb3);
        ...
        collation[76] =
            new Collation(76, new String[] {"utf8mb3_tolower_ci", "utf8_tolower_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        ...
        // 184..191
        collation[192] =
            new Collation(192, new String[] {"utf8mb3_unicode_ci", "utf8_unicode_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[193] = new Collation(193, new String[] {"utf8mb3_icelandic_ci", "utf8_icelandic_ci"}, 0,
            MYSQL_CHARSET_NAME_utf8mb3);
        collation[194] =
            new Collation(194, new String[] {"utf8mb3_latvian_ci", "utf8_latvian_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[195] =
            new Collation(195, new String[] {"utf8mb3_romanian_ci", "utf8_romanian_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[196] = new Collation(196, new String[] {"utf8mb3_slovenian_ci", "utf8_slovenian_ci"}, 0,
            MYSQL_CHARSET_NAME_utf8mb3);
        collation[197] =
            new Collation(197, new String[] {"utf8mb3_polish_ci", "utf8_polish_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[198] =
            new Collation(198, new String[] {"utf8mb3_estonian_ci", "utf8_estonian_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[199] =
            new Collation(199, new String[] {"utf8mb3_spanish_ci", "utf8_spanish_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[200] =
            new Collation(200, new String[] {"utf8mb3_swedish_ci", "utf8_swedish_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[201] =
            new Collation(201, new String[] {"utf8mb3_turkish_ci", "utf8_turkish_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[202] =
            new Collation(202, new String[] {"utf8mb3_czech_ci", "utf8_czech_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[203] =
            new Collation(203, new String[] {"utf8mb3_danish_ci", "utf8_danish_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[204] = new Collation(204, new String[] {"utf8mb3_lithuanian_ci", "utf8_lithuanian_ci"}, 0,
            MYSQL_CHARSET_NAME_utf8mb3);
        collation[205] =
            new Collation(205, new String[] {"utf8mb3_slovak_ci", "utf8_slovak_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[206] =
            new Collation(206, new String[] {"utf8mb3_spanish2_ci", "utf8_spanish2_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[207] =
            new Collation(207, new String[] {"utf8mb3_roman_ci", "utf8_roman_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[208] =
            new Collation(208, new String[] {"utf8mb3_persian_ci", "utf8_persian_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[209] = new Collation(209, new String[] {"utf8mb3_esperanto_ci", "utf8_esperanto_ci"}, 0,
            MYSQL_CHARSET_NAME_utf8mb3);
        collation[210] = new Collation(210, new String[] {"utf8mb3_hungarian_ci", "utf8_hungarian_ci"}, 0,
            MYSQL_CHARSET_NAME_utf8mb3);
        collation[211] =
            new Collation(211, new String[] {"utf8mb3_sinhala_ci", "utf8_sinhala_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[212] =
            new Collation(212, new String[] {"utf8mb3_german2_ci", "utf8_german2_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[213] =
            new Collation(213, new String[] {"utf8mb3_croatian_ci", "utf8_croatian_ci"}, 0, MYSQL_CHARSET_NAME_utf8mb3);
        collation[214] = new Collation(214, new String[] {"utf8mb3_unicode_520_ci", "utf8_unicode_520_ci"}, 0,
            MYSQL_CHARSET_NAME_utf8mb3);
        collation[215] = new Collation(215, new String[] {"utf8mb3_vietnamese_ci", "utf8_vietnamese_ci"}, 0,
            MYSQL_CHARSET_NAME_utf8mb3);
        // 216..222
        collation[223] = new Collation(223, new String[] {"utf8mb3_general_mysql500_ci", "utf8_general_mysql500_ci"}, 0,
            MYSQL_CHARSET_NAME_utf8mb3);
    ...
    public static String getStaticMysqlCharsetNameForCollationIndex(Integer collationIndex) {
        ...
        if (collationIndex != null && collationIndex >= 0 && collationIndex < MAP_SIZE) {
            charset = COLLATION_INDEX_TO_CHARSET[collationIndex];
        }
