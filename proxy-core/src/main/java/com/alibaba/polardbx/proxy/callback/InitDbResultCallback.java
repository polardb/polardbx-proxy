...
public class InitDbResultCallback extends ResultCallbackBase {
    private final String db;

    public InitDbResultCallback(@NotNull FrontendConnection frontend, @NotNull FrontendContext context,
                                @NotNull Scheduler scheduler, String db) {
    ...
    public void onDone(ResultHandler handler, ResultState lastValidState, ResultState state) {
        ...
        // dealing retransmit or abort(retry init db is idempotent)
