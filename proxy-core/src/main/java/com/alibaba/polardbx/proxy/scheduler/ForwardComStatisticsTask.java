...
public class ForwardComStatisticsTask extends ForwardTaskBase {
    private static final Logger LOGGER = LoggerFactory.getLogger(ForwardComStatisticsTask.class);
    ...
    public Boolean forward(Scheduler scheduler) throws Exception {
        ...
        final ResultHandler handler = new StringResultHandler(scheduler.getBackend().getContextReference(), scheduler,
